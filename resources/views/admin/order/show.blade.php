                        ...
                        <div class="card-body pt-0">
                            <div class="table-responsive">
                                <table class="table align-middle table-row-bordered mb-0 fs-6 gy-5 min-w-300px">
                                    ...
                                    <tr>
                                        <td class="text-muted">
                                            <div class="d-flex align-items-center">تاریخ ثبت سفارش</div>
                                        </td>
                                        <td class="fw-bolder text-start">{{ $order->created_at->toJalali('Y/m/d ساعت H:i:s') }}</td>
                                    </tr>
                                    <tr>
                                        <td class="text-muted">
                                        ...
                                        <td class="fw-bolder text-start">
                                            {{ $order->gateway?->name() ?: 'بدون پرداخت' }}
                                            @if($order->gateway)
                                                <img src="{{ asset($order->gateway?->logo()) }}" class="w-50px ms-2" />
                                            @endif
                                        </td>
                                    </tr>
                                    <tr>
                                        ...
                                        <td class="fw-bolder text-start">{!! price_format($order->price) !!}</td>
                                    </tr>
                                    <!--end::Date-->
                                    </tbody>
                                    <!--end::Table body-->
                            ...
                            <div class="table-responsive">
                                <table class="table align-middle table-row-bordered mb-0 fs-6 gy-5 min-w-300px">
                                            ...
                                            <div class="d-flex align-items-center justify-content-start gap-3">
                                                ...
                                                <div class="overflow-hidden me-3">
                                                    <a href="{{ route('admin.user.show', $order->user) }}">
                                                        <img src="{{ $order->user?->featuredImage() }}" alt="{{ $order->user?->publicName() }}" class="w-50px h-50px rounded-circle"/>
                                                    </a>
                                                </div>
                                            </div>
                                        </td>
                                    ...
                                    <tr>
                                        ...
                                        <td class="fw-bolder text-start">
                                            <a href="mailto:{{ $order->user?->email }}" class="text-gray-600 text-hover-primary">{{ $order->user?->email }}</a>
                                        </td>
                                    </tr>
                                    <tr>
                                        <td class="text-muted">
                                        ...
                                        <td class="fw-bolder text-start">{{ $order->user?->phone }}</td>
                                    </tr>
                                    </tbody>
                                </table>
                            </div>
                            ...
                            <div class="card card-flush py-4 flex-row-fluid overflow-hidden">
                                ...
                                <div class="card-header">
                                    <div class="card-title flex gap-3">
                                        <h2>جزئیات پرداخت #{{$order->id}}</h2>
                                        <span class="{{ $order->status->cssClass() }} px-2 py-1 text-white">{{ $order->status->name() }}</span>
                                    </div>
                                </div>
                                <!--end::Card header-->
                                <!--begin::Card body-->
                                        ...
                                        <table class="table align-middle table-row-dashed fs-6 gy-5 mb-0">
                                            ...
                                            <tbody class="fw-bold text-gray-600">
                                                        ...
                                                        <td>
                                                            <div class="d-flex align-items-center">
                                                                ...
                                                                <div class="ms-5">
                                                                    ...
                                                                    <div class="fs-7 text-muted">تاریخ نام نویسی: {{ $order->created_at->toJalali('Y/m/d ساعت H:i:s') }}</div>
                                                                </div>
                                                            </div>
                                                        </td>
                                                ...
                                                <tr>
                                                    ...
                                                    <td class="text-end">{!! price_format($order->subtotal()) !!}</td>
                                                </tr>
                                                <tr>
                                                    <td colspan="3" class="text-end">تخفیف</td>
                                                    <td class="text-end">{!! price_format($order->totalDiscount()) !!}</td>
                                                </tr>
                                                <tr>
                                                    <td colspan="3" class="fs-3 text-dark text-end">قیمت نهایی</td>
                                                    <td class="text-dark fs-3 fw-boldest text-end">{!! price_format($order->totalPrice()) !!}</td>
                                                </tr>
                                                @if($order->description)
                                                    <tr>
                                                        <td class="text-dark fw-boldest text-start">{{ $order->description }}</td>
                                                    </tr>
                                                @endif
