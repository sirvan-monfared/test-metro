                    ...
                    <div class="row mb-5 mb-xl-8 g-5 g-xl-8">
                        <div class="col-6">
                            <div class="card card-stretch">
                                <a href="{{ route('admin.report.income') }}" class="btn btn-flex btn-text-gray-800 btn-icon-gray-400 btn-active-color-primary bg-body flex-column justfiy-content-start align-items-start text-start w-100 p-10">
                                    ...
                                    <!--end::Svg Icon-->
                                    <span class="fs-4 fw-bolder">گزارش درآمدها</span>
                                </a>
                                <!--end::Link-->
                            </div>
                            <!--end::Card-->
                        ...
                        <div class="col-6">
                            <div class="card card-stretch">
                                <a href="{{ route('admin.report.user-register') }}" class="btn btn-flex btn-text-gray-800 btn-icon-gray-400 btn-active-color-primary bg-body flex-column justfiy-content-start align-items-start text-start w-100 p-10">
                                    <span class="svg-icon svg-icon-3x mb-5">
                                        <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none">
                                    ...
                                    <span class="fs-4 fw-bolder">گزارش ثبت نام ها</span>
                                </a>
                            </div>
                        </div>
                        <!--end::Col-->
                    ...
                    <div class="card mb-5 mb-xl-8">
                        ...
                        <div class="card-header align-items-center border-0 mt-4">
                            ...
                            <div class="card-toolbar">
                                ...
                                <!--begin::Menu 1-->
                                <div class="menu menu-sub menu-sub-dropdown w-250px w-md-300px" data-kt-menu="true" id="kt_menu_61de20feb7880">
                                    <!--begin::Header-->
                                    <div class="px-7 py-5">
                                    ...
                                    <div class="px-7 py-5">
                                        ...
                                        <div class="mb-10">
                                            ...
                                            <!--begin::Input-->
                                            <div>
                                                <select class="form-select form-select-solid" data-kt-select2="true" data-placeholder="Select option" data-dropdown-parent="#kt_menu_61de20feb7880" data-allow-clear="true">
                                                    <option></option>
                    ...
                    <div class="card mb-5 mb-xl-8">
                        ...
                        <div class="card-body pt-5">
                            ...
                            <div class="d-flex align-items-sm-center mb-7">
                                ...
                                <div class="symbol symbol-50px me-5">
													<span class="symbol-label">
														<img src="{{ asset('admin/media/svg/brand-logos/plurk.svg') }}" class="h-50 align-self-center" alt="" />
													</span>
                                </div>
                                <!--end::Symbol-->
                                <!--begin::Section-->
                            ...
                            <div class="d-flex align-items-sm-center mb-7">
                                ...
                                <div class="symbol symbol-50px me-5">
													<span class="symbol-label">
														<img src="{{ asset('admin/media/svg/brand-logos/telegram.svg') }}" class="h-50 align-self-center" alt="" />
													</span>
                                </div>
                                <!--end::Symbol-->
                                <!--begin::Section-->
                            ...
                            <div class="d-flex align-items-sm-center mb-7">
                                ...
                                <div class="symbol symbol-50px me-5">
													<span class="symbol-label">
														<img src="{{ asset('admin/media/svg/brand-logos/vimeo.svg') }}" class="h-50 align-self-center" alt="" />
													</span>
                                </div>
                                <!--end::Symbol-->
                                <!--begin::Section-->
                            ...
                            <div class="d-flex align-items-sm-center mb-7">
                                ...
                                <div class="symbol symbol-50px me-5">
													<span class="symbol-label">
														<img src="{{ asset('admin/media/svg/brand-logos/bebo.svg') }}" class="h-50 align-self-center" alt="" />
													</span>
                                </div>
                                <!--end::Symbol-->
                                <!--begin::Section-->
                            ...
                            <div class="d-flex align-items-sm-center mb-7">
                                ...
                                <div class="symbol symbol-50px me-5">
													<span class="symbol-label">
														<img src="{{ asset('admin/media/svg/brand-logos/kickstarter.svg') }}" class="h-50 align-self-center" alt="" />
													</span>
                                </div>
                                <!--end::Symbol-->
                                <!--begin::Section-->
                            ...
                            <div class="d-flex align-items-sm-center">
                                ...
                                <div class="symbol symbol-50px me-5">
													<span class="symbol-label">
														<img src="{{ asset('admin/media/svg/brand-logos/fox-hub.svg') }}" class="h-50 align-self-center" alt="" />
													</span>
                                </div>
                                <!--end::Symbol-->
                                <!--begin::Section-->
                        ...
                        <div class="col-xl-6">
                            <div class="card card-xl-stretch mb-xl-8">
                                <div class="card-header border-0 py-5">
                                    <h3 class="card-title align-items-start flex-column">
                                        <span class="card-label fw-bolder text-dark">درآمدها</span>
                                        <span class="text-muted mt-1 fw-bold fs-7">درآمد 7 روز اخیر</span>
                                    </h3>
                                </div>
                                <div class="card-body d-flex flex-column">
                                    <Chart :yaxis="{{ json_encode($incomeChartData['yAxis']) }}" :xaxis="{{ json_encode($incomeChartData['xAxis']) }}"></Chart>
                                </div>
                            </div>
                        </div>
                        <div class="col-xl-6">
                            <div class="card card-xl-stretch mb-xl-8">
                                <div class="card-header border-0 py-5">
                                    <h3 class="card-title align-items-start flex-column">
                                        <span class="card-label fw-bolder text-dark">ثبت نام ها</span>
                                        <span class="text-muted mt-1 fw-bold fs-7">ثبت نام های 7 روز اخیر</span>
                                    </h3>
                                </div>
                                <div class="card-body d-flex flex-column">
                                    <Chart :format="false" :yaxis="{{ json_encode($registerChartData['yAxis']) }}" :xaxis="{{ json_encode($registerChartData['xAxis']) }}"></Chart>
                                </div>
                            </div>
                        </div>
                    </div>
                                    ...
                                    <div class="d-flex flex-column mt-10">
                                        ...
                                        <div class="d-flex">
                                            ...
                                            <a href="#" class="symbol symbol-35px me-2" data-bs-toggle="tooltip" title="Mark Larson">
                                                <img src="{{ asset('admin/media/avatars/300-5.jpg') }}" alt="" />
                                            </a>
                                            ...
                                            <a href="#" class="symbol symbol-35px" data-bs-toggle="tooltip" title="Alice Micto">
                                                <img src="{{ asset('admin/media/avatars/300-10.jpg') }}" alt="" />
                                            </a>
                                        </div>
                                    </div>
                                    <!--end:Team-->
