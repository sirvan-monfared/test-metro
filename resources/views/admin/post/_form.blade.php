                ...
                <div class="card card-flush py-4">
                    ...
                    <div class="card-body pt-0">
                        <div class="mb-10 fv-row">
                            ...
                            <input type="text" name="title" id="title" class="form-control mb-2" placeholder="عنوان" value="{{ old('title', $post) }}" />
                            <x-admin.error-field :errors="$errors" name="title"></x-admin.error-field>
                        </div>
                        <div class="mb-10 fv-row">
                            <label class="form-label" for="slug">نامک</label>
                            <input type="text" name="slug" id="slug" class="form-control mb-2" placeholder="عنوان" value="{{ old('slug', $post) }}" />
                            <x-admin.error-field :errors="$errors" name="slug"></x-admin.error-field>
                        </div>
                        <div v-pre>
                            <label class="form-label" for="body">متن کامل</label>
                            <textarea name="body" id="body" >{{ old('body', $post) }}</textarea>
                            <x-admin.error-field :errors="$errors" name="body"></x-admin.error-field>
                        </div>
                        <div class="mt-20" v-pre>
                            <label class="form-label" for="short">توضیحات کوتاه</label>
                            <textarea name="short" id="short" >{{ old('short', $post) }}</textarea>
                            <x-admin.error-field :errors="$errors" name="short"></x-admin.error-field>
                        </div>
                    </div>
                </div>
            </div>
                ...
                <div class="card card-flush py-4">
                    ...
                    <div class="card-body pt-0">
                        <div class="mb-10">
                            ...
                            <input type="text" class="form-control mb-2" name="seo__title" id="seo__title" placeholder="تایتل" value="{{ old('seo__title', $post->getSeoTitleProperty()) }}"/>
                            <div class="text-muted fs-7">تایتل سئو را وارد کنید</div>
                        </div>
                        <div class="mb-10">
                            <label class="form-label" for="seo__description">تگ description</label>
                            <textarea id="seo__description" name="seo__description" class="form-control mb-2">{{ old('seo__description', $post->getSeoDescriptionProperty()) }}</textarea>
                        ...
                        <div>
                            ...
                            <input id="seo__keywords" name="seo__keywords" class="form-control mb-2" value="{{ old('seo__keywords', $post->getSeoKeywordsProperty()) }}" />
