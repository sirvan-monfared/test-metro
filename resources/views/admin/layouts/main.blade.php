...
<!--begin::Head-->
<head>
    <title>مدیریت | لاراپلاس</title>
    <meta charset="utf-8" />
    <meta name="description" content="لاراپلاس" />
    <meta name="keywords" content="لاراپلاس" />
    <meta name="viewport" content="width=device-width, initial-scale=1" />
    <meta property="og:locale" content="fa_IR" />
    <meta property="og:type" content="article" />
    <meta property="og:title" content="لاراپلاس" />
    <meta property="og:url" content="https://laraplus.ir" />
    <meta property="og:site_name" content="laraplus" />
    <link rel="canonical" href="https://laraplus.ir/admin" />
    <link rel="shortcut icon" href="{{ asset('admin/media/logos/favicon.ico') }}" />

    @yield('css')

    <!--begin::Page Vendor Stylesheets(used by this page)-->
    <link href="{{ asset('admin/plugins/custom/leaflet/leaflet.bundle.rtl.css') }}" rel="stylesheet" type="text/css" />
...
<!--begin::Main-->
<!--begin::Root-->
<div class="d-flex flex-column flex-root" @if(! isset($prevent_vue) || ! $prevent_vue) id="app" @endif>
    <!--begin::Page-->
        ...
        <div id="kt_aside" class="aside" data-kt-drawer="true" data-kt-drawer-name="aside" data-kt-drawer-activate="{default: true, lg: false}" data-kt-drawer-overlay="true" data-kt-drawer-width="auto" data-kt-drawer-direction="start" data-kt-drawer-toggle="#kt_aside_toggle">
            ...
            <div class="aside-logo flex-column-auto pt-10 pt-lg-10" id="kt_aside_logo">
                <a href="{{ route('admin.dashboard') }}">
                    <img alt="Logo" src="{{ asset('assets/img/laraplus-logo.svg') }}" class="h-60px" />
                </a>
            </div>
            <!--end::Logo-->
            <!--begin::Nav-->
            @include('admin._side_menu')
            ...
            <div class="aside-footer flex-column-auto pb-5 pb-lg-10" id="kt_aside_footer">
                ...
                <div class="d-flex flex-center w-100 scroll-px" data-bs-toggle="tooltip" data-bs-placement="right" data-bs-dismiss="click" title="Quick actions">
                    ...
                    <div class="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-800 menu-state-bg-light-primary fw-bold w-200px" data-kt-menu="true">
                        ...
                        <div class="menu-item px-3">
                            <a href="{{ route('front.home') }}" class="menu-link px-3" target="_blank">مشاهده سایت</a>
                        </div>
                        <!--end::Menu item-->
                        <!--begin::Menu item-->
                        <div class="menu-item px-3">
                            <a href="{{ route('admin.sitemap.generate') }}" class="menu-link px-3">ساخت نقشه سایت</a>
                        </div>
                        <!--end::Menu item-->
                        <!--begin::Menu item-->
                ...
                <div class="container d-flex flex-stack">
                    ...
                    <div class="d-flex align-items-center flex-grow-1 flex-lg-grow-0">
                        <a href="../../demo9/dist/index.html">
                            <img alt="Logo" src="{{ asset('admin/media/logos/logo-demo9.svg') }}" class="h-35px" />
                        </a>
                    </div>
                    <!--end::Mobile logo-->
                    <!--begin::Aside toggle-->
                ...
                <div class="header-container container-xxl">
                    ...
                    <div class="page-title d-flex flex-column align-items-start justify-content-center flex-wrap me-lg-20 py-3 py-lg-0 me-3">
                        ...
                        <h1 class="d-flex flex-column text-dark fw-bolder my-1">
                            <span class="text-white fs-1">{{ $page_title ?? null }}</span>
                            <small class="text-gray-600 fs-6 fw-normal pt-2">{{ $page_description ?? null }}</small>
                        </h1>
                        <!--end::Heading-->
                    </div>
                    <!--end::Page title=-->
                    ...
                    <div class="d-flex align-items-center flex-wrap">
                                        ...
                                        <div data-kt-search-element="results" class="d-none">
                                            ...
                                            <div class="scroll-y mh-200px mh-lg-350px">
                                                ...
                                                <a href="#" class="d-flex text-dark text-hover-primary align-items-center mb-5">
                                                    ...
                                                    <div class="symbol symbol-40px me-4">
																<span class="symbol-label bg-light">
																	<img class="w-20px h-20px" src="{{ asset('admin/media/svg/brand-logos/volicity-9.svg') }}" alt="" />
																</span>
                                                    </div>
                                                    <!--end::Symbol-->
                                                    <!--begin::Title-->
                                                ...
                                                <a href="#" class="d-flex text-dark text-hover-primary align-items-center mb-5">
                                                    ...
                                                    <div class="symbol symbol-40px me-4">
																<span class="symbol-label bg-light">
																	<img class="w-20px h-20px" src="{{ asset('admin/media/svg/brand-logos/tvit.svg') }}" alt="" />
																</span>
                                                    </div>
                                                    <!--end::Symbol-->
                                                    <!--begin::Title-->
                                                ...
                                                <a href="#" class="d-flex text-dark text-hover-primary align-items-center mb-5">
                                                    ...
                                                    <div class="symbol symbol-40px me-4">
																<span class="symbol-label bg-light">
																	<img class="w-20px h-20px" src="{{ asset('admin/media/svg/misc/infography.svg') }}" alt="" />
																</span>
                                                    </div>
                                                    <!--end::Symbol-->
                                                    <!--begin::Title-->
                                                ...
                                                <a href="#" class="d-flex text-dark text-hover-primary align-items-center mb-5">
                                                    ...
                                                    <div class="symbol symbol-40px me-4">
																<span class="symbol-label bg-light">
																	<img class="w-20px h-20px" src="{{ asset('admin/media/svg/brand-logos/leaf.svg') }}" alt="" />
																</span>
                                                    </div>
                                                    <!--end::Symbol-->
                                                    <!--begin::Title-->
                                                ...
                                                <a href="#" class="d-flex text-dark text-hover-primary align-items-center mb-5">
                                                    ...
                                                    <div class="symbol symbol-40px me-4">
																<span class="symbol-label bg-light">
																	<img class="w-20px h-20px" src="{{ asset('admin/media/svg/brand-logos/tower.svg') }}" alt="" />
																</span>
                                                    </div>
                                                    <!--end::Symbol-->
                                                    <!--begin::Title-->
                                        ...
                                        <div class="" data-kt-search-element="main">
                                            ...
                                            <div class="scroll-y mh-200px mh-lg-325px">
                                                ...
                                                <div class="d-flex align-items-center mb-5">
                                                    ...
                                                    <!--begin::Title-->
                                                    <div class="d-flex flex-column">
                                                        <a href="https://laraplus.ir" class="fs-6 text-gray-800 text-hover-primary fw-bold">تهیه و توسعه توسط لاراپلاس www.laraplus.ir</a>
                        ...
                        <div class="d-flex align-items-center py-3 py-lg-0">
                            ...
                            <livewire:daily-stats></livewire:daily-stats>

                            @include('admin.header.user_menu')
                            <!--begin::Theme mode-->
                            ...
                            @if(isset($create_link))
                                <a href="{{ $create_link }}" class="btn btn-primary">افزودن</a>
                            @endif
            ...
            <div class="footer py-4 d-flex flex-lg-column" id="kt_footer">
                ...
                <div class="container-xxl d-flex flex-column flex-md-row flex-stack">
                    ...
                    <div class="text-dark order-2 order-md-1">
                        <span class="text-gray-400 fw-bold me-1"><a href="https://laraplus.ir" class="fs-6 text-gray-800 text-hover-primary fw-bold">طراحی و توسعه توسط  </a></span>
                        <a href="https://laraplus.ir" target="_blank" class="text-muted text-hover-primary fw-bold me-2 fs-6">لاراپلاس</a>
                    </div>
                    <!--end::Copyright-->
                    <!--begin::Menu-->
                    <!--end::Menu-->
                        ...
                        <div class="timeline-content mb-10 mt-n1">
                            ...
                            <div class="overflow-auto pb-5">
                                <div class="d-flex align-items-center border border-dashed border-gray-300 rounded min-w-700px p-5">
                                    ...
                                    <div class="d-flex flex-aligns-center pe-10 pe-lg-20">
                                        <!--begin::Icon-->
                                        <img alt="../../demo9/dist/apps/projects/project.html" class="w-30px me-3" src="{{ asset('admin/media/svg/files/doc.svg') }}" />
                                        <!--end::Icon-->
                                        <!--begin::Info-->
                                        <div class="ms-1 fw-bold">
                                            <!--begin::Desc-->
                                    ...
                                    <div class="d-flex flex-aligns-center">
                                        <!--begin::Icon-->
                                        <img alt="../../demo9/dist/apps/projects/project.html" class="w-30px me-3" src="{{ asset('admin/media/svg/files/css.svg') }}" />
                                        <!--end::Icon-->
                                        <!--begin::Info-->
                                        <div class="ms-1 fw-bold">
                                            <!--begin::Desc-->
                                ...
                                <div class="d-flex align-items-center border border-dashed border-gray-300 rounded min-w-700px p-7">
                                    ...
                                    <div class="overlay me-10">
                                        ...
                                        <div class="overlay-wrapper">
                                            <img alt="img" class="rounded w-150px" src="{{ asset('admin/media/stock/600x400/img-29.jpg') }}" />
                                        </div>
                                        <!--end::Image-->
                                        <!--begin::Link-->
                                    ...
                                    <div class="overlay me-10">
                                        <!--begin::Image-->
                                        <div class="overlay-wrapper">
                                            <img alt="img" class="rounded w-150px" src="{{ asset('admin/media/stock/600x400/img-31.jpg') }}" />
                                        </div>
                                        <!--end::Image-->
                                        <!--begin::Link-->
                                        <div class="overlay-layer bg-dark bg-opacity-10 rounded">
                                    ...
                                    <div class="overlay">
                                        <!--begin::Image-->
                                        <div class="overlay-wrapper">
                                            <img alt="img" class="rounded w-150px" src="{{ asset('admin/media/stock/600x400/img-40.jpg') }}" />
                                        </div>
                                        <!--end::Image-->
                                        <!--begin::Link-->
                                        <div class="overlay-layer bg-dark bg-opacity-10 rounded">
                        ...
                        <div class="row g-5">
                            ...
                            <div class="col-6">
                                ...
                                <div class="overlay overflow-hidden position-relative border border-4 border-gray-200 rounded">
                                    <div class="overlay-wrapper">
                                        <img src="{{ asset('admin/media/demos/demo1.png') }}" alt="demo" class="w-100" />
                                    </div>
                            ...
                            <div class="col-6">
                                ...
                                <div class="overlay overflow-hidden position-relative border border-4 border-gray-200 rounded">
                                    <div class="overlay-wrapper">
                                        <img src="{{ asset('admin/media/demos/demo2.png') }}" alt="demo" class="w-100" />
                                    </div>
                                    <div class="overlay-layer bg-dark bg-opacity-10">
                            ...
                            <div class="col-6">
                                ...
                                <div class="overlay overflow-hidden position-relative border border-4 border-gray-200 rounded">
                                    <div class="overlay-wrapper">
                                        <img src="{{ asset('admin/media/demos/demo3.png') }}" alt="demo" class="w-100" />
                                    </div>
                                    <div class="overlay-layer bg-dark bg-opacity-10">
                            ...
                            <div class="col-6">
                                ...
                                <div class="overlay overflow-hidden position-relative border border-4 border-gray-200 rounded">
                                    <div class="overlay-wrapper">
                                        <img src="{{ asset('admin/media/demos/demo4.png') }}" alt="demo" class="w-100" />
                                    </div>
                                    <div class="overlay-layer bg-dark bg-opacity-10">
                            ...
                            <div class="col-6">
                                ...
                                <div class="overlay overflow-hidden position-relative border border-4 border-gray-200 rounded">
                                    <div class="overlay-wrapper">
                                        <img src="{{ asset('admin/media/demos/demo5.png') }}" alt="demo" class="w-100" />
                                    </div>
                                    <div class="overlay-layer bg-dark bg-opacity-10">
                            ...
                            <div class="col-6">
                                ...
                                <div class="overlay overflow-hidden position-relative border border-4 border-gray-200 rounded">
                                    <div class="overlay-wrapper">
                                        <img src="{{ asset('admin/media/demos/demo6.png') }}" alt="demo" class="w-100" />
                                    </div>
                                    <div class="overlay-layer bg-dark bg-opacity-10">
                            ...
                            <div class="col-6">
                                ...
                                <div class="overlay overflow-hidden position-relative border border-4 border-gray-200 rounded">
                                    <div class="overlay-wrapper">
                                        <img src="{{ asset('admin/media/demos/demo7.png') }}" alt="demo" class="w-100" />
                                    </div>
                                    <div class="overlay-layer bg-dark bg-opacity-10">
                            ...
                            <div class="col-6">
                                ...
                                <div class="overlay overflow-hidden position-relative border border-4 border-gray-200 rounded">
                                    <div class="overlay-wrapper">
                                        <img src="{{ asset('admin/media/demos/demo8.png') }}" alt="demo" class="w-100" />
                                    </div>
                                    <div class="overlay-layer bg-dark bg-opacity-10">
                            ...
                            <div class="col-6">
                                ...
                                <div class="overlay overflow-hidden position-relative border border-4 border-success rounded">
                                    <div class="overlay-wrapper">
                                        <img src="{{ asset('admin/media/demos/demo9.png') }}" alt="demo" class="w-100" />
                                    </div>
                                    <div class="overlay-layer bg-dark bg-opacity-10">
                            ...
                            <div class="col-6">
                                ...
                                <div class="overlay overflow-hidden position-relative border border-4 border-gray-200 rounded">
                                    <div class="overlay-wrapper">
                                        <img src="{{ asset('admin/media/demos/demo10.png') }}" alt="demo" class="w-100" />
                                    </div>
                                    <div class="overlay-layer bg-dark bg-opacity-10">
                            ...
                            <div class="col-6">
                                ...
                                <div class="overlay overflow-hidden position-relative border border-4 border-gray-200 rounded">
                                    <div class="overlay-wrapper">
                                        <img src="{{ asset('admin/media/demos/demo11.png') }}" alt="demo" class="w-100" />
                                    </div>
                                    <div class="overlay-layer bg-dark bg-opacity-10">
                            ...
                            <div class="col-6">
                                ...
                                <div class="overlay overflow-hidden position-relative border border-4 border-gray-200 rounded">
                                    <div class="overlay-wrapper">
                                        <img src="{{ asset('admin/media/demos/demo12.png') }}" alt="demo" class="w-100" />
                                    </div>
                                    <div class="overlay-layer bg-dark bg-opacity-10">
                            ...
                            <div class="col-6">
                                ...
                                <div class="overlay overflow-hidden position-relative border border-4 border-gray-200 rounded">
                                    <div class="overlay-wrapper">
                                        <img src="{{ asset('admin/media/demos/demo13.png') }}" alt="demo" class="w-100" />
                                    </div>
                                    <div class="overlay-layer bg-dark bg-opacity-10">
                            ...
                            <div class="col-6">
                                ...
                                <div class="overlay overflow-hidden position-relative border border-4 border-gray-200 rounded">
                                    <div class="overlay-wrapper">
                                        <img src="{{ asset('admin/media/demos/demo14.png') }}" alt="demo" class="w-100" />
                                    </div>
                                    <div class="overlay-layer bg-dark bg-opacity-10">
                            ...
                            <div class="col-6">
                                ...
                                <div class="overlay overflow-hidden position-relative border border-4 border-gray-200 rounded">
                                    <div class="overlay-wrapper">
                                        <img src="{{ asset('admin/media/demos/demo15.png') }}" alt="demo" class="w-100" />
                                    </div>
                                    <div class="overlay-layer bg-dark bg-opacity-10">
                            ...
                            <div class="col-6">
                                ...
                                <div class="overlay overflow-hidden position-relative border border-4 border-gray-200 rounded">
                                    <div class="overlay-wrapper">
                                        <img src="{{ asset('admin/media/demos/demo16.png') }}" alt="demo" class="w-100" />
                                    </div>
                                    <div class="overlay-layer bg-dark bg-opacity-10">
                            ...
                            <div class="col-6">
                                ...
                                <div class="overlay overflow-hidden position-relative border border-4 border-gray-200 rounded">
                                    <div class="overlay-wrapper">
                                        <img src="{{ asset('admin/media/demos/demo17.png') }}" alt="demo" class="w-100" />
                                    </div>
                                    <div class="overlay-layer bg-dark bg-opacity-10">
                            ...
                            <div class="col-6">
                                ...
                                <div class="overlay overflow-hidden position-relative border border-4 border-gray-200 rounded">
                                    <div class="overlay-wrapper">
                                        <img src="{{ asset('admin/media/demos/demo18.png') }}" alt="demo" class="w-100" />
                                    </div>
                                    <div class="overlay-layer bg-dark bg-opacity-10">
                            ...
                            <div class="col-6">
                                ...
                                <div class="overlay overflow-hidden position-relative border border-4 border-gray-200 rounded">
                                    <div class="overlay-wrapper">
                                        <img src="{{ asset('admin/media/demos/demo19.png') }}" alt="demo" class="w-100" />
                                    </div>
                                    <div class="overlay-layer bg-dark bg-opacity-10">
                            ...
                            <div class="col-6">
                                ...
                                <div class="overlay overflow-hidden position-relative border border-4 border-gray-200 rounded">
                                    <div class="overlay-wrapper">
                                        <img src="{{ asset('admin/media/demos/demo20.png') }}" alt="demo" class="w-100" />
                                    </div>
                                    <div class="overlay-layer bg-dark bg-opacity-10">
                            ...
                            <div class="col-6">
                                ...
                                <div class="overlay overflow-hidden position-relative border border-4 border-gray-200 rounded">
                                    <div class="overlay-wrapper">
                                        <img src="{{ asset('admin/media/demos/demo21.png') }}" alt="demo" class="w-100 opacity-25" />
                                    </div>
                                    <div class="overlay-layer bg-dark bg-opacity-10">
                            ...
                            <div class="col-6">
                                ...
                                <div class="overlay overflow-hidden position-relative border border-4 border-gray-200 rounded">
                                    <div class="overlay-wrapper">
                                        <img src="{{ asset('admin/media/demos/demo22.png') }}" alt="demo" class="w-100 opacity-25" />
                                    </div>
                                    <div class="overlay-layer bg-dark bg-opacity-10">
                                        <div class="badge badge-white px-6 py-4 fw-bold fs-base shadow">Coming soon</div>
                                    </div>
                            ...
                            <div class="col-6">
                                ...
                                <div class="overlay overflow-hidden position-relative border border-4 border-gray-200 rounded">
                                    <div class="overlay-wrapper">
                                        <img src="{{ asset('admin/media/demos/demo23.png') }}" alt="demo" class="w-100 opacity-25" />
                                    </div>
                                    <div class="overlay-layer bg-dark bg-opacity-10">
                                        <div class="badge badge-white px-6 py-4 fw-bold fs-base shadow">Coming soon</div>
                                    </div>
                            ...
                            <div class="col-6">
                                ...
                                <div class="overlay overflow-hidden position-relative border border-4 border-gray-200 rounded">
                                    <div class="overlay-wrapper">
                                        <img src="{{ asset('admin/media/demos/demo24.png') }}" alt="demo" class="w-100 opacity-25" />
                                    </div>
                                    <div class="overlay-layer bg-dark bg-opacity-10">
                                        <div class="badge badge-white px-6 py-4 fw-bold fs-base shadow">Coming soon</div>
                                    </div>
                                    ...
                                    <div class="d-flex flex-column mb-7 fv-row">
                                        ...
                                        <div class="position-relative">
                                            ...
                                            <div class="position-absolute translate-middle-y top-50 end-0 me-5">
                                                ...
                                                <img src="{{ asset('admin/media/svg/card-logos/mastercard.svg') }}" alt="" class="h-25px" />
                                                <img src="{{ asset('admin/media/svg/card-logos/american-express.svg') }}" alt="" class="h-25px" />
                                            </div>
                                            <!--end::Card logos-->
                                        </div>
                                        <!--end::Input wrapper-->
                            ...
                            <div data-kt-stepper-element="content">
                                <div class="w-100 text-center">
                                    ...
                                    <div class="text-center px-4 py-15">
                                        <img src="{{ asset('admin/media/illustrations/sigma-1/9.png') }}" alt="" class="mw-100 mh-300px" />
                                    </div>
                                    <!--end::Illustration-->
                                </div>
                            </div>
                    ...
                    <div class="py-5">
                        ...
                        <div data-kt-search-element="empty" class="text-center d-none">
                            ...
                            <div class="text-center px-5">
                                <img src="{{ asset('admin/media/illustrations/sigma-1/1.png') }}" alt="" class="w-100 h-200px h-sm-325px" />
                            </div>
                            <!--end::Illustration-->
                        </div>
                        <!--end::Empty-->
        ...
        <div class="modal-content">
            ...
            <div class="modal-body scroll-y mx-5 mx-xl-18 pt-0 pb-15">
                ...
                <div class="btn btn-light-primary fw-bolder w-100 mb-8">
                    <img alt="Logo" src="{{ asset('admin/media/svg/brand-logos/google-icon.svg') }}" class="h-20px me-3" />Invite Gmail Contacts</div>
...
<script src="{{ asset('admin/js/scripts/helpers.js') }}"></script>
<script src="{{ asset('application/vue.js') }}"></script>
